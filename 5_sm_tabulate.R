...
save(regave_weatherhead,regave_no,ResultsTab_no,ResultsTab_weatherhead,disc_betap2_weatherhead,disc2_betap2_weatherhead,Chlcontent,trend_betap2_no,trend_betap2_weatherhead,file="sm_Results_tables.Rdata")

     
     save(isdiff,isdiffdm1,isdiffdm2,file="sm_significance.Rdata")