...
ResultsTab_weatherhead <- array(NA,dim=c(23,8))
...
colnames(ResultsTab_weatherhead) <- c("Region","Trend Value","Lower Confidence Interval","Upper confidence interval","RMSE","discmag1","ldm1","udm1")
...
ResultsTab_weatherhead[indio,] <- c(indio,mean(weatherhead_betap[2,,j]),bounds_weatherhead[2,],RMSE_weatherhead,disc,bounds_disc)
...
save(diffbetween,ResultsTab_no,ResultsTab_weatherhead,disc_betap2_weatherhead,Chlcontent,trend_betap2_no,trend_betap2_weatherhead,file="sw_Results_tables.Rdata")

     
     save(isdiff,isdiffdm1,file="sw_significance.Rdata")